...
func (o *Order) SetFilledAvgPriceNil() {
...
// SetLegs gets a reference to the given []Order and assigns it to the Legs field.
...
func (o *Order) SetTrailPercentNil() {
